                    ...
                    <div class="navbar-inverse side-collapse in">
                        <nav id="MainMenu">
                            <div class="list-group panel" >
                                <li class="list-group-item list-group-item-success"><a href="adminPannelMainCat" id="leftAllLink" >Main Category(MC)<span class="arrow"></span></a></li>
	...
	<div class="rightTop">
		<div class="top-call">
			<div class="subBox">
				<div class="noLogo">
					<div class="logo-bg ">
						<a href=""><img src="images/logo-in.png" alt="Radius7"/></a>
					</div>
				</div>
			</div>
			<a href="adminPannelHome"><div class="call">
				<p>Go To >> <br/><span>Admin Dashboard</span></p>
			</div></a>
            <div class="user nav ">
				<ul>
					<li class="dropdown dropdown-user">
						<a data-close-others="true" data-hover="dropdown" data-toggle="dropdown" class="dropdown-toggle" href="javascript:;">
						<span class="username username-hide-on-mobile">Hi Vishal </span>
						<b class="caret"></b></a>
