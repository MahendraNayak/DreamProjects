    ...
    <div class="rightInfo landing-page-wrapper">
        <div class="padding-txt">
            <div class="col-xs-12 category-header">
                <Marquee><b>MAIN ITEM SUPPLIER RATE</b></Marquee>
            </div>
        </div>
        <div class="in-services">
		    <div class="col-md-3 col-sm-6">
		        <div class="panel panel-default" style="width:1017px">
					...
					<br><input type="text" placeholder="CT" id="contratorName" name="contratorName" class="form-control" autofocus>
				</div>
				<div class="col-sm-9" style="width:499px;margin-left:482px;margin-top:-51px">
					<br><input type="text" placeholder="CP" id="contratorPriority" name="contratorPriority" class="form-control" autofocus>
				</div>
				...
				<div class="col-sm-9" style="width:499px;margin-left:482px;margin-top:-51px">
					<br><input type="text" placeholder="IR" id="installationRT" name="installationRT" class="form-control" autofocus>
				</div>
