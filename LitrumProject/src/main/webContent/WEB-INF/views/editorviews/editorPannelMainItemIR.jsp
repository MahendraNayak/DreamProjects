		    ...
		    <div class="col-md-3 col-sm-6">
		        <div class="panel panel-default" style="width:1017px">
				    ...
				    <div class="panel-body" style="padding:0;border:0px;height:333px;overflow-y:auto;margin-top:6px">
                        		<div class="col-sm-9" style="width:981px"><h4 style="color:#4d20d8">MAIN ITEM INSTALLATION RATE MODULE</h4></div>
                                <div class="col-sm-9" style="width:981px"><br>
                                    <select class="form-control" name="cityId" id="cityId" onChange="getAvailableMainItemContractor()">
                                ...
                                <div class="col-sm-9" style="width:981px"><br>
                                    <select class="form-control" name="shortDescription" id="shortDescription" onChange="getMainItemLoadUnit(this.value);getAvailableMainItemContractor()">
				...
				<div class="col-sm-9" style="width:981px"><h4 style="color:#4d20d8">MAIN ITEM INSTALLATION RATE INPUT MODULE</h4></div>
				<div class="col-sm-9" style="width:499px">
            	...
            	<div id="row">
            		<div class="col-md-3 col-sm-6">
            			<div class="panel panel-default" style="width:1017px">
            				<div class="panel-heading"><h3 class="panel-title">AVAILABLE CONTRACTORS LIST BASED ON CITY AND MAIN ITEM</h3></div>
            					<div class="panel-body" style="padding:0;border:0px;height:333px;overflow-y:auto;margin-top:6px" id="MI_CONTRACTOR_TABLE">
            					</div>
            			</div>
            		</div>
            	</div>
